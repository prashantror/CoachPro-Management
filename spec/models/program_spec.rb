...
RSpec.describe Program, type: :model do
  ...
  describe "cover_image_url" do
    ...
    xit "returns the URL of the attached cover image" do
      program = Program.new
      program.cover_image.attach(io: File.open(Rails.root.join('spec', 'fixtures', 'default-cover-image.png')), filename: 'default-cover-image.png', content_type: 'image/jpeg')
  ...
  describe "gallery_image_urls" do
    ...
    xit "returns an array of URLs for attached gallery images" do
      program = Program.new
      program.gallery_images.attach(io: File.open(Rails.root.join('spec', 'fixtures', 'default-cover-image.png')), filename: 'default-cover-image.png', content_type: 'image/jpeg')
      program.gallery_images.attach(io: File.open(Rails.root.join('spec', 'fixtures', 'default-company-logo.png')), filename: 'default-company-logo.png', content_type: 'image/jpeg')
